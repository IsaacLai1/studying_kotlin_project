package com.example.test.face_reg.camera_processing
...
class GraphicOverlay(context: Context?, attrs: AttributeSet?) :
    ...
    var scalePicture: Float? = null
    var offSetPointX : Float? = null
    var offSetPointY: Float? = null
    ...
    abstract class Graphic(private val overlay: GraphicOverlay) {
        ...
        fun calculateRect(height: Float, width: Float, boundingBoxT: Rect): RectF {
            ...
            overlay.offSetPointX = offsetX
            overlay.offSetPointY = offsetY
